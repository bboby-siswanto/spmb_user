        ...
        <form method="post" id="form_edit_academic_history" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="admission_type" name="admission_type" <?=($student_data->student_type == 'exchange') ? 'readonly' : '';?>>
                    <option value="">---</option>
                    <option value="regular" <?=($student_data->student_type == 'regular') ? 'selected' : '';?>>Regular</option>
                    <option value="transfer" <?=($student_data->student_type == 'transfer') ? 'selected' : '';?>>Transfer</option>
                    <?php
            ...
            <div class="form-group">
                <label for="admission_type">Your Choice of Study Program</label>
...
-->
            ...
            <div class="form-group">
                <label for="school_name">High School Name</label>
                ...
                <!-- <select name="schoole_name" id="schoole_name" class="form-control"></select> -->
...
<script type="text/javascript">
    $(function() {
        ...
        function change_study_program() {
            ...
            let program_id = '<?= ($study_program_data) ? $study_program_data->program_id : 1 ?>';
        ...
        $('select#schoole_name').select2({
            minimumInputLength: 3,
            allowClear: true,
            placeholder: "Please select",
            theme: "bootstrap",
            ajax: {
                url: '<?=base_url()?>candidate/education/get_institution_by_name',
                type: "POST",
                dataType: 'json',
                ...
                processResults: function(result) {
                    ...
                    return {
                        results: $.map(data, function (item) {
                            return {
                                text: item.institution_name + ' (' + item.address_province + ')',
        ...
        // $("select#schoole_name").select2("container").find("div.select2-drop").append('<table width="100%"><tr><td class="row"><button class="btn btn-block btn-default btn-xs" onClick="modal()">Add new Item</button></div></td></tr></table>');
