<div class="row">
    <div class="col-md-6 text-center my-auto">
	    <div class="my-3 pb-5">
		    ...
		    <p>
                ...
                Full Scholarships @Rp 255.000.000 <br> (Development fee and 8 semesters fee)
		    </p>
	    </div>
	    <div class="my-3">
		    <!-- <i class="fas fa-scroll fa-3x mr-2"></i>  <i class="ml-2 mr-2 fas fa-plus fa-2x"></i> <i class="fas fa-scroll fa-3x ml-2"></i> -->
		    <i class="fas fa-medal fa-3x mr-2"></i>
			<p>Partial scholarships @Rp 105.000.000<br> (Development fee and 8 semesters fee)</p>
	    </div>
	    <!-- <div class="my-3">
    ...
    <div class="col-md-6 text-center">
        ...
        <form method="post" id="registration_form">
            <input type="hidden" name="scholarship_id" id="scholarship_id" value="f0007fb7-b81b-11e9-849d-5254005d90f6">
