<div class="row">
    <div class="col-md-6 text-center my-auto">
	    ...
	    <div class="my-3">
			...
			<p>Get a national and <strong class="text-danger">international</strong> bachelor degree in <strong class="text-danger">4 years!</strong></p>
	    </div>
	    <div class="my-3">
