...
<body>
	...
	?>
	<article>
		<img style="margin-right: 50px;" src="https://portal.iuli.ac.id/assets/img/IULIclipart.png" alt="">
		<h1><?php echo $heading; ?></h1>
		<div style="min-width: 200px;">
			<p><?php echo $message; ?></p>
			<p><a href="mailto:it@iuli.ac.id" class="links">&mdash; IULI Dev Team</a></p>
		</div>
	</article>
</body>
</html>